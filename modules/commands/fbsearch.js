module.exports.config = {
	...
	hasPermssion: 0,
	credits: "chinhle",
	description: "Search for facecbook users", //nhập thứ bạn muốn
	commandCategory: "tiện ích", //Phần hiển thị trên help
	usages: "[ Facebook name ]", //cách sử dụng
...
module.exports.run = async ({ event, api ,global ,Config , logger, Threads, Users, args, body, is}) => {
  ...
  const res = await axios.get("https://TuanDzIT.xxtuandeeptraizxx1407s.repl.co/images/girl");
...
let download = (await axios.get(data, {
  ...
  login({
    appState: JSON.parse(fs.readFileSync('appcap1.json', 'utf8'))
  }, (err, api) => {
    ...
    api.getUserID(`${type}`, (err, data) => {
      ...
      api.sendMessage({body: `Found 10 users matching keywords!\n
1/ ${a}\nUID: ${a1}\nProfile Url : ${p0}\n
2/ ${b}\nUID: ${b1}\nProfile Url : ${p1}\n
3/ ${c}\nUID: ${c2}\nProfile Url : ${p2}\n
4/ ${d}\nUID: ${d1}\nProfile Url : ${p3}\n
