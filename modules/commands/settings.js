module.exports.config = {
  ...
  if (o == `12:00:${i}` && i < 6)
    for (let n of h) setTimeout((() => e.sendMessage(`〉It's now: ${o}\n[❗] Bot will proceed to restart !`, n, (() => process.exit(1)))), 1e3)
  ...
  if (!s[0]) return e.sendMessage("| Here are the bot's full settings | 🛠\n=== Manage Settings ===\n[1] Prefix.\n[2] Bot name.\n[3] Admin List.\n[4] Language.\n[5] Auto-restart.\n=== Activity Manager ===\n[6] Check for updates.\n[7] Get list of banned users.\n[8] Get list of banned groups forbidden.\n[9] Send notice to all groups.\n[10]. Search UID by username.\n[11]. Search box TID by name box\n[12]. Change emoji box\n[13]. Rename box\n[14]. See info box\n-> To select, reply to this message with <-", n.threadID, ((e, a) => {
  ...
  switch (l = 1, s.type) {
    case "choose":
      switch (n.body) {
        ...
        case "2":
          return e.sendMessage("The name of the bot is : " + global.config.BOTNAME, n.threadID, n.messageID);
        case "3": {
        ...
        case "4":
          ...
          break;
        case "5":
          return e.sendMessage("Bot will restart at 12h", n.threadID, n.messageID);
        case "6":
          return e.sendMessage("Currently the bot is in version : " + global.config.version, n.threadID, n.messageID);
        case "7": {
      ...
      case "14": {
        ...
        let t = a.adminIDs.length,
          ...
          i = a.threadID,
          g = a.approvalMode;
        var f = 0 == g ? "off" : 1 == g ? "on" : "Kh";
        e.sendMessage(`✨Name: ${h}\n🤖 Box ID: ${i}\n👀 Approve: ${f}\n🧠 Emoji: ${o}\n 👉 Info: includes ${ s} members\n👦Male : ${p} members\n👩‍  Female: ${y} members\nWith ${t} admin\n🕵️‍♀️ Total messages: ${r} tin.\n`, n.threadID)
      }
      }
      break;
    case "sendnoti": {
      ...
      return e.sendMessage(`Successfully sent to: ${M} group\n\nFailed ${T.length} group`, n.threadID, n.messageID)
    }
    case "getuid":
    ...
    case "emojibox":
      try {
        e.changeThreadEmoji(n.body, n.threadID, (() => e.sendMessage(`🔨 The bot has successfully changed Emoji to: ${n.body}`, n.threadID, n.messageID)))
      } catch (a) {
