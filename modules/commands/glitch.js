...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome?text=${encodeURIComponent(test)}&text2=${encodeURIComponent(test2)}&theme=glitch&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
