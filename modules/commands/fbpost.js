...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  const res = await axios.get(`https://graph.facebook.com/${uid}?fields=name,first_name,email,about,birthday,gender,website,hometown,link,location,quotes,relationship_status,significant_other.limite(0)&access_token=463372798834978|csqGyA8VWtIhabZZt-yhEBStl9Y`);
...
/*---------------------------------------------*/
  ...
  ctx.textAlign = "start";
  fontSize = 5;
  ctx.fillText(`${res.data.name}`, 58, 20);
  ctx.font = `400 18px Arial`;
