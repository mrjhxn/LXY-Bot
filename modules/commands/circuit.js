...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome?text=${encodeURIComponent(test)}&theme=circuit&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
