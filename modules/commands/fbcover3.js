...
if (args[0] == "list") {
  ...
  var source = res.data.search.source;
	if (!nhanvat) return api.sendMessage(`[⚜️] Enter the id you want to see the info\n[⚜️] Dùng ${global.config.PREFIX}taoanhdep list to see the list of characters `, event.threadID, event.messageID);
