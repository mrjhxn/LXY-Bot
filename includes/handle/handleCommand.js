...
//// admin -pa /////
    ...
    if (!NDH.includes(senderID) && !ADMINBOT.includes(senderID) && adminbot.ndhOnly == true) {
      if (!NDH.includes(senderID) && !ADMINBOT.includes(senderID) && adminbot.ndhOnly == true) return api.sendMessage('MODE » Only support bots can use bots', threadID, messageID)
    }
...
𝗖𝗼𝗺𝗺𝗮𝗻𝗱 𝗡𝗮𝗺𝗲 : ${command.config.name} 
𝗖𝗼𝗼𝗹𝗱𝗼𝘄𝗻 𝗹𝗲𝗳𝘁 : ${((timestamps.get(senderID) + expirationTime - dateNow)/1000).toString().slice(0, 5)} secs 

please use commands slowly!!!
